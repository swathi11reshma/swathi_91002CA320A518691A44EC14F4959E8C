  ...
  def withdraw(self, amount):
    if(amount > 0 and amount <= self.__account_balance):
     ...
     print("withdraw rs{}. New balance: rs{}".format(amount,self.__account_balance))
      ...
      print("Invalid withdrawal amount or insufficient blance:")

  def display_balance(self):
    print("Account balance for {}.(Account rs{}): rs{}".format(self.__account_holder_name,self.__account_number,self.__account_balance))
